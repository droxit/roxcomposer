...
# source: mosaic/communication/service_com.proto
...
MosaicMessage = _reflection.GeneratedProtocolMessageType('MosaicMessage', (_message.Message,), dict(
  ...
  __module__ = 'mosaic.communication.service_com_pb2'
